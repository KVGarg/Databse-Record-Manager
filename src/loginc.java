...
class loginc extends JFrame implements ActionListener {
    ...
    loginc() {
        ...
        l6 = new JLabel("Father Name", SwingConstants.LEFT);
        l7 = new JLabel("Mother Name", SwingConstants.LEFT);
        l8 = new JLabel("Address", SwingConstants.LEFT);
        l9 = new JLabel("Mobile Number", SwingConstants.LEFT);
        l10 = new JLabel("Crime", SwingConstants.LEFT);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == b2) {
            try {
                conn c1 = new conn();
                String qry = "insert into criminal(Name,Gender,DOB,Age,Class,Father_Name,Mother_Name,Address,Blood_Group,Mobile_No) values(" + "'" + t2.getText() + "','" + t3.getText() + "','" + t4.getText() + "','" + t5.getText() + "','" + t6.getText() + "','" + t7.getText() + "','" + t8.getText() + "','" + t9.getText() + "','" + t10.getText() + "')";
                c1.update(qry);
        ...
        if (ae.getSource() == b6) {
            try {
                conn c2 = new conn();
                ResultSet rs = c2.execute("select * from criminal where Name=" + "'" + t1.getText() + "'");
                t1.setText(" ");
                if (rs.next()) {
                    ...
                    t7.setText(rs.getString("Mother_Name"));
                    t8.setText(rs.getString("Address"));
                    t9.setText(rs.getString("Mobile_No"));
                    t10.setText(rs.getString("Crime"));
        ...
        if (ae.getSource() == b4) {
            JOptionPane.showMessageDialog(null, "Enter criminal Name in Search Bar");
        }
        if (ae.getSource() == b5) {
        ...
        if (ae.getSource() == b3) {
            try {
                String s1 = "update criminal set Name='" + t2.getText() + "',Gender='" + t3.getText() + "',DOB='" + t4.getText() + "',Age='" + t5.getText() + "',Father_Name='" + t6.getText() + "',Mother_Name='" + t7.getText() + "',Address='" + t8.getText() + "',Mobile_No='" + t9.getText() + "',Crime='" + t10.getText() + "'where Name='" + t2.getText() + "'";
                conn c3 = new conn();
                c3.update(s1);
